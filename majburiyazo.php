<?php
define("API_KEY","7035842554:AAESWQ6b_56NYbZKgAPlTg5TfT-S1OzbwNE");
$admin = "";
...
🌐 Bu bot guruhga kim qancha odam qo'shganligini aytib beruvchiva kanalga a'zo bo'lmasa guruhda yoza olmaslikni ta'minlaydigan robot. Botni admin qilib tayinlashni unutmang!
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"📲 Kanalimiz",'url'=>"t.me/dasturchinet"],['text'=>"👥 Guruhimiz",'url'=>"t.me/dasturchinet"]]
]
])
]);
}else{
...
'chat_id'=> $cid,
'parse_mode'=>"html",
'text'=>"🔵 <b>Kechirasiz</b> <a href='tg://user?id=$cid'>$name</a> <b>botdan to'liq foydalanish uchun</b> <a href='t.me/dasturchinet'>@DasturchiNet</a> <b>kanaliga a'zo bo'ling va tekshirish tugmasini bosing!

📛 Agar kanaldan chiqib ketsangiz bot sizning guruhda ishlamay qoladi.</b>",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➕ A'zo bo'lish",'url'=>"t.me/DasturchiNet"]],
...
'text'=>"📛 Siz @DasturchiNet kanalimizga a'zo bo'lmadingiz!",
'show_alert'=>true,
]);
}
}
...
if ($tx == "/mymembers" or $tx == "/mymembers@manzil"){
if ($cty == "supergroup"){
if (!$replyid){
bot ('sendmessage', [
'chat_id'=> $cid,
...
✅<b>Namuna:</b>
<code>/setchannel @dasturchinet</code>",
'reply_to_message_id'=> $mid,
]);
}
}

if ($tx == "/setchannel" or $tx == "/start" or $tx == "/setchannel@Bot" or $tx == "/stat"){
if ($cty == "supergroup"){
$us = bot ('getChatMember', [
'chat_id'=> $chan,
'user_id'=> $uid,
